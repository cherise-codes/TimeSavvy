        ...
        <CENTER>
         ...
         <div class="col-md-offset-3 col-md-6"> 
            ...
            <div id="LogIn" class="tabcontent">   <!--login form-->
              <!--    <form class="form-horizontal"  method="post"  action="http://localhost:8080/timeSavvy/LogIn">  -->
                <form class="form-horizontal"  method="post"  action="vist_Bean.jsp"> 
                <span class="heading">Time Savvy</span>
                <div class="form-group">
                    <input type="text" class="form-control" id="LogInEmail"  name="username"
                    placeholder="Please enter our username" autofocus required autocomplete required/>
            ...
            <div id="NewAccount" class="tabcontent">  <!--NewAccount form-->
              <!-- <form class="form-horizontal"  method="post" action="http://localhost:8080/timeSavvy/LogIn" > -->
                ...
                <div class="form-group">
                    <input type="email" class="form-control" id="NewAccountEmail" name="password" placeholder="Please input your email address" autofocus required autocomplete required/>
